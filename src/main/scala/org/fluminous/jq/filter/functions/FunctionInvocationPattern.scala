...
import org.fluminous.jq.tokens.symbolic.{ LeftBracket, RightBracket, SemiColon }
...
object FunctionInvocationPattern extends ExpressionPattern {
  override protected val ExpressionCases: PatternCases = PatternCases[FunctionNInvocation](
    ...
    (test[SemiColon] ->: capture[Filter] ->: capture[FunctionNInvocationStart]).ifValidReplaceBy {
